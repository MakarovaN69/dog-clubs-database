...
namespace newKursBd
{
    partial class Diagram1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.headerTextLabel.TabIndex = 1;
            this.headerTextLabel.Text = "Клубы и число собак в этих клубах";
            ...
            this.Name = "Diagram1";
            this.Text = "Одномерная диаграмма";
            this.Load += new System.EventHandler(this.Diagram1_Load);
